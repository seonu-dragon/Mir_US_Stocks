...
- **시세정보 · 투자정보 (2026-09-26, `quote-info.js` + `quote-info-core.js`)**: 종목 분석 뷰의 요약 옆 카드(`#range52Bar`, 예전 52주 레인지 바 자리)와 핵심 지표 카드 맨 위. 네이버 종목 상세 좌측 패널 구성을 따른다. node 테스트 `scripts/tests/test_quote_info_core.mjs`(CI).
...
- **기업개요 · 목표주가 범위 (2026-09-26, `company-info.js` + `company-info-core.js`)**: 종목 분석 뷰 오른쪽 열, 시세정보 카드 아래.
