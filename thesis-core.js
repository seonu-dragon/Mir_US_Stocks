...
(function (root) {
  ...
  const METRICS = {
    ...
    pe:              { label: "PER", unit: "x", kind: "number", markets: ["us", "kr"], nearRel: 0.1, source: "map_fundamentals · 상세" },
    forwardPE:       { label: "선행 PER", unit: "x", kind: "number", markets: ["us", "kr"], nearRel: 0.1, source: "map_fundamentals · 상세" },
    pb:              { label: "PBR", unit: "x", kind: "number", markets: ["us", "kr"], nearRel: 0.1, source: "map_fundamentals · 상세" },
    ps:              { label: "PSR", unit: "x", kind: "number", markets: ["us", "kr"], nearRel: 0.1, source: "map_fundamentals · 상세" },
    operMargin:      { label: "영업이익률", unit: "pct", kind: "number", markets: ["us", "kr"], nearAbs: 2, source: "상세 JSON(fundamentals.operMargin)" },
    netMargin:       { label: "순이익률", unit: "pct", kind: "number", markets: ["us", "kr"], nearAbs: 2, source: "map_fundamentals · 상세" },
    roe:             { label: "ROE", unit: "pct", kind: "number", markets: ["us", "kr"], nearAbs: 2, source: "map_fundamentals · 상세" },
    revenueGrowth:   { label: "매출 성장률(YoY)", unit: "pct", kind: "number", markets: ["us", "kr"], nearAbs: 2, source: "US: 상세 연간 재무(최근 2개년) · KR: map_fundamentals" },
    operatingGrowth: { label: "영업이익 성장률(YoY)", unit: "pct", kind: "number", markets: ["us", "kr"], nearAbs: 5, source: "US: 상세 연간 재무(최근 2개년) · KR: map_fundamentals" },
    debtRatio:       { label: "부채비율", unit: "pct", kind: "number", markets: ["kr"], nearAbs: 10, source: "map_fundamentals" },
    divYield:        { label: "배당수익률", unit: "pct", kind: "number", markets: ["us", "kr"], nearAbs: 0.3, source: "map_fundamentals" },
    rsi14:           { label: "RSI(14)", unit: "num", kind: "number", markets: ["us", "kr"], nearAbs: 5, source: "시장 스냅샷" },
    high52Gap:       { label: "52주 고점 대비 하락폭", unit: "pct", kind: "number", markets: ["us", "kr"], nearAbs: 3, source: "시장 스냅샷(newHighDistancePct)" },
    sma200Gap:       { label: "200일선 대비 괴리율", unit: "pct", kind: "number", markets: ["us", "kr"], nearAbs: 2, source: "상세 JSON 일봉 200개 단순평균" },
    guidanceLowered: { label: "가이던스 하향", kind: "event", markets: ["us"], source: "실적 보도자료 요약(earnings_releases) 가이던스 분류" },
    ...
    earningsWithin:  { label: "실적 발표 임박", kind: "event", markets: ["us"], param: { key: "days", label: "D-일", def: 7, min: 0, max: 30 }, near: true, source: "us_calendar 다음 실적 예정일" },
  };
